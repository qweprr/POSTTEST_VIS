...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' Sewabtn
        ' 
        Sewabtn.Location = New Point(206, 203)
        Sewabtn.Name = "Sewabtn"
        Sewabtn.Size = New Size(224, 29)
        Sewabtn.TabIndex = 14
        Sewabtn.Text = "Sewa Game"
        Sewabtn.UseVisualStyleBackColor = True
        ' 
        ' Form1
        ' 
        ClientSize = New Size(682, 493)
        Controls.Add(Sewabtn)
        Controls.Add(Label4)
        Controls.Add(Label3)
        Controls.Add(Label2)
        Controls.Add(Label1)
